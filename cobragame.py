...
print("=====Welcome to Cobra Game!=====")
while True :
    print("1. Easy")
    print("2. Medium")
    print("3. Hard")
    print("4. Extreme")
    risposta = input("Choose the difficulty level : ")
    if risposta == "1" :
        SPEED = 200
        break
    elif risposta == "2" :
        ...
        print("That's not an existent difficulty! Try again")
